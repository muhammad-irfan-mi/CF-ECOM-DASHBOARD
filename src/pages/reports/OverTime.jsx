            ...
            <div
                ...
                <table className="border-collapse border border-gray-300">
                    ...
                    <thead className={`sticky top-0 ${context.colors.boxbg} z-[99]`}>
                        <tr>
                            <th rowSpan={2} className={`border border-gray-300 py-5 w-64 h-[65px] fixed ${context.colors.boxbg}`}>Employees</th>
                            <th rowSpan={2} className="border border-gray-300 px-4 py-2">
                                Overtime Days
                            </th>

                            {daysInMonth.map((day) => (
                                <th key={day.day} className="border border-gray-300  px-8 py-2 text-center">
